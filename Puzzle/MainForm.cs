        ...
        private void MainForm_MouseUp(object sender, MouseEventArgs e)
        {
            if (_canMovePiece)
            {
                ...
                if (adjacentClusterIDs.Count > 0)
                {
                    ...
                    clusterPicture = ImageUtilities.AlphaBlendMatrix(modifiedClusterPicture, clusterPicture, 255);//200);
        ...
        private ResponseMessage CreateJigsawPuzzle()
        {
            ...
            {                
                for (int col = 0; col < GameSettings.NUM_COLUMNS; col++)
                {
                    ...
                    piecePicture = ImageUtilities.AlphaBlendMatrix(modifiedPiecePicture, piecePicture, 255);//200);
